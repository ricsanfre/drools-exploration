...
public class RuleTest {
    ...
    private KieContainer createKieContainer() {
        ...
        String packagePath = "com.ricsanfre.drools".replace(".", "/");
        ...
        ReleaseId releaseId = ks.newReleaseId("com.ricsanfre", "drools-tests-traditional", "1.0-SNAPSHOT");
